...
public class Cd11DataProviderConfig {
  ...
  public static final String DEFAULT_STATION_NAME = "DEF";
  public static final String DEFAULT_STATION_TYPE = "NDC";
   ...
   * @param stationType IDC, IMS, or NDC (CD 1.1 Connection Request/Response Frames).
  ...
  public static class Builder {
    ...
    /**
     * Station type as specified in the CD 1.1 Protocol: IMS, IDC, NDC, etc.
     *
