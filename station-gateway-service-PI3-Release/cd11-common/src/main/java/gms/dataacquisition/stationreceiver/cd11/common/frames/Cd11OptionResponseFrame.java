...
public class Cd11OptionResponseFrame extends Cd11Frame {
  ...
  public String toString() {
    StringBuilder out = new StringBuilder("Cd11OptionResponseFrame: ");
    out.append("optionCount=").append(1); // TODO: Fix once we accept more than one option.
    out.append(" optionType=").append(optionType);
    out.append(" optionSize=").append(optionResponse.length());
    out.append(" optionRequestLength=").append(optionResponse.length());
    return out.toString();
  }
}
