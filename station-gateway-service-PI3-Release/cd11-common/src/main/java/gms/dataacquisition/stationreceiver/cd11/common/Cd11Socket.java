...
public final class Cd11Socket {
  ...
  public String getRemoteIpAddressAsString() {
    return getRemoteIpAddress().getHostAddress();
  }
   ...
   * @param maxWaitTimeMs Continuously attempt to connect until this limit is exceeded. < 0: Wait
   * forever. = 0: Only try to connect once. > 0: Wait for the specified period of time.
  ...
  public Cd11ConnectionRequestFrame createCd11ConnectionRequestFrame()
    ...
    Cd11ConnectionRequestFrame newFrame = new Cd11ConnectionRequestFrame(
        ...
        (socket == null) ? "0.0.0.0" : socket.getLocalAddress().getHostAddress(),
  ...
  public void sendCd11OptionResponseFrame(int optionType, String optionResponse) throws Exception {
    // Create and send the object.
    this.write(this.createCd11OptionResponseFrame(optionType, optionResponse));
  }
