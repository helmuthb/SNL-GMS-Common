...
public class Cd11SocketConfig {
  ...
  public static final String DEFAULT_STATION_OR_RESPONDER_NAME = "DEF";
  public static final String DEFAULT_STATION_OR_RESPONDER_TYPE = "NDC";
   ...
   * @param stationOrResponderType IDC, IMS, or NDC (CD 1.1 Connection Request/Response Frames).
  ...
  public static class Builder {
    ...
    /**
     * Station or responder type as specified in the CD 1.1 Protocol: IMS, IDC, NDC, etc.
     *
