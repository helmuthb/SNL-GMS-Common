...
public class FrameUtilities {
   ...
   * correct time and year on Jan 1st then add the days, to easily handle the ddd -> mmdd conversion
   * Example Julian Date Input: 2017346 23:20:00.142 Example Instance Output:
   ...
   *
   * @param i the instant
   * @return Example Instant input '2017-12-13T23:20:00.142Z' will yield: '2017346 23:20:00.142'.
   */
  ...
  public static String intToIpAddressString(int ipAddress) throws UnknownHostException {
    return (InetAddress
        .getByAddress(BigInteger.valueOf(ipAddress).toByteArray()))
        .getHostAddress();
  }
}
