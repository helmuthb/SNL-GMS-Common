...
public class DataManConfigurationLoader {
  ...
  public static DataManConfig load() {
    return DataManConfig.builder()
        .setOsdGatewayHostname(getString("osdGatewayHostname", DataManConfig.DEFAULT_OSD_GATEWAY_HOSTNAME))
        .setOsdGatewayPort(getInt("osdGatewayPort", DataManConfig.DEFAULT_OSD_GATEWAY_PORT))
