...
public class Cd11DataConsumerConfig {
  ...
  public static final String DEFAULT_OSD_GATEWAY_IP_ADDRESS = "127.0.0.1";
  ...
  public static final String DEFAULT_RESPONDER_TYPE = "NDC";
  ...
  public final String osdGatewayServiceIpAddress;
  public final int osdGatewayServicePort;
   ...
   * @param responderType IDC, IMS, or NDC (CD 1.1 Connection Request/Response Frames).
  ...
  private Cd11DataConsumerConfig(
      ...
      UUID osdStationId,
      String osdGatewayServiceIpAddress, int osdGatewayServicePort,
    ...
    this.osdGatewayServiceIpAddress = osdGatewayServiceIpAddress;
    this.osdGatewayServicePort = osdGatewayServicePort;
  ...
  public static class Builder {
    ...
    private String osdGatewayServiceHost;
    private int osdGatewayServicePort;
    ...
    private Builder(int dataConsumerPort, UUID osdStationId, String dataProviderStationName) {
      ...
      this.dataProviderStationName = dataProviderStationName;
      this.osdGatewayServiceHost = DEFAULT_OSD_GATEWAY_IP_ADDRESS;
      this.osdGatewayServicePort = DEFAULT_OSD_GATEWAY_PORT;
    ...
    public Cd11DataConsumerConfig build() {
      ...
      // Validate osdGatewayServiceIpAddress
      Validate.notBlank(osdGatewayServiceHost);

      // Validate osdGatewayServicePort
      Cd11Validator.validNonZeroPortNumber(osdGatewayServicePort);
      ...
      return new Cd11DataConsumerConfig(
          ...
          osdStationId, osdGatewayServiceHost, osdGatewayServicePort,
          fsOutputDirectory,
          threadName,
    ...
    /**
     * The IP Address of the OSD Gateway Service.
     *
     * @param value IP address.
     * @return Configuration built from this {@link Builder}, not null
     */
    public Builder setOsdGatewayServiceHost(String value) {
      this.osdGatewayServiceHost = value;
      return this;
    }

    /**
     * The Port number of the OSD Gateway Service.
     *
     * @param value Port number.
     * @return Configuration built from this {@link Builder}, not null
     */
    public Builder setOsdGatewayServicePort(int value) {
      this.osdGatewayServicePort = value;
      return this;
    }
    ...
    /**
     * IMS, IDC, NDC, 0, etc (default: 0). (See the CD 1.1 Protocol for details)
     *
