...
public class Cd11ConnectionManagerConfig {
   ...
   *
   * @param osdGatewayHostname IP address of the OSD Gateway service.
   * @param osdGatewayPort Port number of the OSD Gateway service.
  ...
  public static class Builder {
    ...
    /**
     * Responder type as specified in the CD 1.1 Protocol: IMS, IDC, NDC, etc.
     *
