...
public class Cd11Connection extends GracefulThread {
  ...
  private static final org.slf4j.Logger logger = LoggerFactory.getLogger(Cd11Connection.class);
  ...
  public Cd11Connection(
    ...
    this.remoteIpAddress = ((InetSocketAddress) socket.getRemoteSocketAddress())
