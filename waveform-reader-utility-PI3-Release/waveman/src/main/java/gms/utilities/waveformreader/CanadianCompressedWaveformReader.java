...
public class CanadianCompressedWaveformReader implements WaveformReaderInterface {
  ...
  @Override
  public int[] read(InputStream input, int N, int skip) throws IOException {
    // Extract the canadian compressed data
    int[] data = CanadianCompression.read(input, skip + N, false);
  ...
  private static class CanadianCompression {
     ...
     * @throws IOException
     */
    public static int[] read(InputStream is, int N, boolean interlace) throws IOException
    {
     ...
     * @throws IOException
     */
    private static int readDataBlock(BitInputStream bis, byte[] bits, int[] data, int n) throws IOException
    {
      int N = data.length;
     ...
     * @param end
     */
    private static void integrate(int[] data, int start, int end)
    {
