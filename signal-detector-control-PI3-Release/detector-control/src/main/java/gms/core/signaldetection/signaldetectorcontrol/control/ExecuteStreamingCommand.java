...
public class ExecuteStreamingCommand {
  ...
  private final ChannelSegment channelSegment;
   ...
   * @param signalDetectorParameters A collection of parameters used by the
   * signal detection plugin, i.e., trigger/detrigger threshold, STA/LTA time
   * lag, etc.
  ...
  private ExecuteStreamingCommand(ChannelSegment channelSegment,
      Instant startTime,
      Instant endTime,
      //TODO: to be included when SignalDetectorParameters is implemented
      //SignalDetectorParameters signalDetectorParameters,
