...
public class HttpServiceConfigurationLoaderTests {
  ...
  @Before
  public void setUp() {
    final String propertyFile = "gms/core/signaldetection/signaldetectorcontrol/osdgateway/util/application.properties";
  ...
  public void testLoadConfiguration() {
    ...
    assertEquals("/signal-detection/signal-detector/detector-control/osd-gateway/test-base",
        config.getBaseUrl());
