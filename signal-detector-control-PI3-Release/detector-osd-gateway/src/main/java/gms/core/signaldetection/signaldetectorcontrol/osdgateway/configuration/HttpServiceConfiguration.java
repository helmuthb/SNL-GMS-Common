...
import gms.core.signaldetection.signaldetectorcontrol.osdgateway.Application;
import java.util.Objects;
import java.util.function.BiPredicate;

/**
 * HttpServiceConfiguration values for {@link Application}.
...
public class HttpServiceConfiguration {
  ...
  static final String DEFAULT_BASE_URL = "/signal-detection/signal-detector-control/";
