...
class TestValidationMethods(unittest.TestCase):
    ...
    def test_bad_time_range(self):
        self.assertFalse(validate.validate_time_range(self.goodIsoStringLong, self.goodIsoStringShort))

    def test_bad_time_range_mixed_format(self):
        self.assertFalse(validate.validate_time_range(self.goodIsoStringLong, self.goodEpochString))
