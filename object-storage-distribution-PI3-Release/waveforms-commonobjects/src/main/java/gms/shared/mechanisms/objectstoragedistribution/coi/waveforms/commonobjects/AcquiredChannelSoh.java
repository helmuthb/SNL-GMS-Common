...
public abstract class AcquiredChannelSoh<StatusType> {
  ...
  private final UUID id, processingChannelId;
   ...
   *
   * @param processingChannelId the id of the processing channel
   ...
   */
  public AcquiredChannelSoh(UUID processingChannelId, AcquiredChannelSohType type,
      Instant startTime, Instant endTime, StatusType status, CreationInfo creationInfo) {

    this(UUID.randomUUID(), processingChannelId, type, startTime, endTime, status, creationInfo);
  }
   ...
   * @throws IllegalArgumentException if string arg is empty
   */
  public AcquiredChannelSoh(UUID id, UUID processingChannelId, AcquiredChannelSohType type,
      Instant startTime, Instant endTime, StatusType status, CreationInfo creationInfo) {
  ...
  public boolean hasSameState(AcquiredChannelSoh otherSoh) {
    return otherSoh != null &&
        Objects.equals(this.getProcessingChannelId(), otherSoh.getProcessingChannelId()) &&
