...
public class AcquiredChannelSohBoolean extends AcquiredChannelSoh<Boolean> {
   ...
   */
  public static AcquiredChannelSohBoolean create(UUID processingChannelId,
      AcquiredChannelSohType type,
      Instant startTime, Instant endTime, boolean status, CreationInfo creationInfo) {

    return new AcquiredChannelSohBoolean(UUID.randomUUID(), processingChannelId,
   ...
   * @throws IllegalArgumentException if string arg is empty
   */
  public static AcquiredChannelSohBoolean from(UUID id, UUID processingChannelId,
      AcquiredChannelSohType type,
      Instant startTime, Instant endTime, boolean status, CreationInfo creationInfo) {

    return new AcquiredChannelSohBoolean(id, processingChannelId,
        type, startTime, endTime, status, creationInfo);
  }
   ...
   * @throws IllegalArgumentException if string arg is empty
   */
  private AcquiredChannelSohBoolean(UUID id, UUID processingChannelId, AcquiredChannelSohType type,
      Instant startTime, Instant endTime, boolean status, CreationInfo creationInfo) {
