...
public class QcMaskVersionDao {
  ...
  private List<QcMaskVersionReferenceDao> parentQcMasks;
  ...
  public List<QcMaskVersionReferenceDao> getParentQcMasks() {
    return parentQcMasks;
  }

  public void setParentQcMasks(
      List<QcMaskVersionReferenceDao> parentQcMasks) {
