...
public enum QcMaskCategory {
  ...
  WAVEFORM_QUALITY(Arrays.asList(QcMaskType.REPAIRABLE_GAP, QcMaskType.LONG_GAP, QcMaskType.SPIKE,
      QcMaskType.REPEATED_ADJACENT_AMPLITUDE_VALUE)),
  STATION_SOH(Arrays.asList(QcMaskType.SENSOR_PROBLEM, QcMaskType.STATION_PROBLEM,
      QcMaskType.CALIBRATION, QcMaskType.STATION_SECURITY, QcMaskType.TIMING)),
  CHANNEL_PROCESSING(Collections.emptyList()),
  ANALYST_DEFINED(Arrays.asList(QcMaskType.REPAIRABLE_GAP, QcMaskType.LONG_GAP, QcMaskType.SPIKE,
      QcMaskType.REPEATED_ADJACENT_AMPLITUDE_VALUE)),
