...
public class SignalDetection {
  ...
  public static SignalDetection create(String monitoringOrganization, UUID stationId,
      String phase, List<FeatureMeasurement> featureMeasurements, UUID creationInfoId) {
  ...
  /**
   * Creates a new rejected {@link SignalDetectionHypothesis} for this SignalDetection by copying
   * an existing SignalDetectionHypothesis.
   *
  ...
  public void reject(UUID signalDetectionHypothesisIdToClone, UUID creationInfoId) {
    ...
    signalDetectionHypotheses.add(
        SignalDetectionHypothesis.from(UUID.randomUUID(), sdh.getParentSignalDetectionId(),
            sdh.getPhase(), true, sdh.getFeatureMeasurements(), creationInfoId));
  }
   ...
   */
  public void addSignalDetectionHypothesis(String phase,
    ...
    SignalDetectionHypothesis signalDetectionHypothesis = SignalDetectionHypothesis.from(
        UUID.randomUUID(), getId(), phase, false, featureMeasurements, creationInfoId);
