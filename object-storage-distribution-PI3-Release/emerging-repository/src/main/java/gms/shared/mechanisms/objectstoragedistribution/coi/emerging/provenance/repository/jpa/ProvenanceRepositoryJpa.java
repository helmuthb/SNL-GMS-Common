...
public class ProvenanceRepositoryJpa implements ProvenanceRepository {
  ...
  /**
   * Obtain an instance of {@link ProvenanceRepositoryJpa} using a default {@link EntityManagerFactory}
   */
  public ProvenanceRepositoryJpa() {
    this(ProvenanceEntityManagerFactories.create());
  }
