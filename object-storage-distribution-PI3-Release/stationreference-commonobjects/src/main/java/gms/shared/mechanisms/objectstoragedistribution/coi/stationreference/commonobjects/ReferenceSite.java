...
public final class ReferenceSite {
  ...
  public static ReferenceSite create(String name, String description, InformationSource source,
    ...
    return new ReferenceSite(UUID.randomUUID(), UUID.randomUUID(), name, description,
        source, comment, latitude, longitude,
        elevation, actualChangeTime, Instant.now(), position, aliases);

  }

  /**
   * Create a new ReferenceSite object, as a new version of an existing entity.
   *
   * @param name The site name.
   * @param description A description of the site.
   * @param comment Information about the site.
   ...
   * @return A ReferenceSite object.
   */
  public static ReferenceSite createNewVersion(
      UUID entityId, String name, String description,
      InformationSource source, String comment, double latitude,
      double longitude, double elevation, Instant actualChangeTime,
      RelativePosition position, List<ReferenceAlias> aliases) {

    return new ReferenceSite(entityId, UUID.randomUUID(), name, description,
        source, comment, latitude, longitude,
        elevation, actualChangeTime, Instant.now(),
        position, aliases);
  }
