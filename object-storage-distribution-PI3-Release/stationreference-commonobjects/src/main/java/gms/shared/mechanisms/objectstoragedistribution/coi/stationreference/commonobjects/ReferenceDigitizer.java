...
public final class ReferenceDigitizer {
  ...
  public static ReferenceDigitizer create(String name, String manufacturer, String model,
      String serialNumber, Instant actualChangeTime, InformationSource informationSource,
      String comment, String description) throws NullPointerException {

    return new ReferenceDigitizer(UUID.randomUUID(), UUID.randomUUID(), name,
        manufacturer, model, serialNumber, actualChangeTime,
        Instant.now(), informationSource, comment, description);
  }

  /**
   * Create a new ReferenceDigitizer object, as a new version of an existing entity.
   *
   * @param name the name of the digitizer
   * @param manufacturer Digitizer manufacturer
   * @param model Digitizer model
   ...
   * @throws NullPointerException
   */
  public static ReferenceDigitizer createNewVersion(
      UUID entityId, String name, String manufacturer, String model,
      String serialNumber, Instant actualChangeTime, InformationSource informationSource,
      String comment, String description) throws NullPointerException {

    return new ReferenceDigitizer(entityId, UUID.randomUUID(), name, manufacturer, model,
        serialNumber, actualChangeTime,
        Instant.now(), informationSource, comment, description);
  }
  ...
  // Private Constructor
  private ReferenceDigitizer(UUID entityId, UUID versionId, String name, String manufacturer, String model,
