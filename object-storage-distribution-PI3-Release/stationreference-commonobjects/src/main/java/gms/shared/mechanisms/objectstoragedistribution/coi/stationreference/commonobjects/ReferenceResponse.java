...
public final class ReferenceResponse {
  ...
  public static ReferenceResponse create(UUID channelId, String responseType,
      byte[] responseData, String units, Instant actualTime,
      InformationSource informationSource, String comment) {

    return new ReferenceResponse(UUID.randomUUID(), channelId, responseType, responseData, units,
   ...
   * Private constructor.
   */
  private ReferenceResponse(UUID id, UUID channelId, String responseType, byte[] responseData, String units,
