...
public final class ReferenceStationMembership {
  ...
  public static ReferenceStationMembership create(String comment, Instant actualChangeTime,
    ...
    return new ReferenceStationMembership(UUID.randomUUID(), comment, actualChangeTime,
        Instant.now(), stationId, siteId, status);
  }
  ...
  /**
   * Compare two membership records, if the site ID and the station ID match,
