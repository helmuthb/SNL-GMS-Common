...
public class ParameterValidation {
  ...
  private final static Logger logger = LoggerFactory.getLogger(ParameterValidation.class);

  private ParameterValidation() {
  }

  /**
   * Validation method that requires the validator to return true given the input object,
  ...
  /**
   * Validation method that requires the validator to return true given the input objects,
   * otherwise logs the message and throws a RuntimeException with that message.
   *
   * @param validator Predicate used to validate the input objects. Note BiPredicate can be a method
   * reference representing (o1, o2) -> method(o1, o2) or (o1, o2) -> o1.method(o2), opening up lots
   * of possible validation methods.
  ...
  /**
   * Validation method that requires the validator to return false given the input object,
   * otherwise logs the message and throws a RuntimeException with that message.
   *
   * @param validator Predicate used to validate the input object.
   * @param object Input object to be validated.
