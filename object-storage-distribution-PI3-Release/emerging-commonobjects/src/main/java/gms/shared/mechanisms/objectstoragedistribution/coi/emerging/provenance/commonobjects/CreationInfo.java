...
public class CreationInfo {
  ...
  /**
   * Constructor to use when the object is created from a DAO, it will set the
   * creation time to the value that is obtained from the database.
   *
   * @param creatorName The name of the entity creating the associated object.
   * @param creationTime The time the associated object was created.
   * @param softwareInfo The SoftwareComponentInfo object.
   */
  public CreationInfo(String creatorName, Instant creationTime, SoftwareComponentInfo softwareInfo)
