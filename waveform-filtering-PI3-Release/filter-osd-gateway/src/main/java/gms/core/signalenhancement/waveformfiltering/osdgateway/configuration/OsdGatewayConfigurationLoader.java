...
import gms.core.signalenhancement.waveformfiltering.osdgateway.util.ConfigurationLoader;
import java.net.URL;
...
public class OsdGatewayConfigurationLoader {
  ...
  public static OsdGatewayConfiguration load() {
    ...
    final String path = "gms/core/signalenhancement/waveformfiltering/osdgateway/util/application.properties";
