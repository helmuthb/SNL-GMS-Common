package gms.core.signalenhancement.waveformfiltering.osdgateway;

import gms.core.signalenhancement.waveformfiltering.osdgateway.configuration.HttpServiceConfiguration;
import gms.core.signalenhancement.waveformfiltering.osdgateway.configuration.HttpServiceConfigurationLoader;
import gms.core.signalenhancement.waveformfiltering.osdgateway.configuration.OsdGatewayConfiguration;
import gms.core.signalenhancement.waveformfiltering.osdgateway.configuration.OsdGatewayConfigurationLoader;
import gms.core.signalenhancement.waveformfiltering.osdgateway.gateway.ContentType;
import gms.core.signalenhancement.waveformfiltering.osdgateway.gateway.ErrorHandler;
import gms.core.signalenhancement.waveformfiltering.osdgateway.gateway.GatewayHandler;
import gms.core.signalenhancement.waveformfiltering.osdgateway.gateway.OsdGateway;
import gms.core.signalenhancement.waveformfiltering.osdgateway.gateway.StandardResponse;
...
public class Application {
  ...
  public static void start() {
    ...
    final String propertiesFile = "gms/core/signalenhancement/waveformfiltering/osdgateway/util/application.properties";
  ...
  private static void configureRoutes(HttpServiceConfiguration serviceConfig,
    ...
    logger.info("Configuring FilterControl OSD Gateway Service routes.  Base URL: {}",
    ...
    Function<Request, StandardResponse> storeClosure = r -> gatewayHandler
        .storeChannelSegments(parseContentType(r), r.bodyAsBytes(), parseAcceptType(r));
