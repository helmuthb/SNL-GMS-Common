...
public class HttpServiceConfigurationLoaderTests {
  ...
  @Before
  public void setUp() {
    final String propertyFile = "gms/core/signalenhancement/waveformfiltering/osdgateway/util/application.properties";
  ...
  public void testLoadConfiguration() {
    ...
    assertEquals("/signal-enhancement/waveform-filtering/osd-gateway/test-base",
        config.getBaseUrl());
