...
public class CssStationRefLoaderConfiguration {
  ...
  private CssStationRefLoaderConfiguration(String serviceHost, short servicePort) {
  ...
  /**
   * Constructs instances of {@link CssStationRefLoaderConfiguration} following the builder pattern
   */
  public static class Builder {
    ...
    /**
     * Construct the {@link CssStationRefLoaderConfiguration}
     *
     ...
     */
    public CssStationRefLoaderConfiguration build() {
      ...
      return new CssStationRefLoaderConfiguration(serviceHost, servicePort);
    }
