...
public abstract class WfdiscRecord {
  ...
  private static final org.slf4j.Logger logger = LoggerFactory.getLogger(WfdiscRecord.class);
  ...
  /**
    ...
    public void validate() {
        ...
        if (!getSegtype().equals("d") && !getSegtype().equals("o") && !getSegtype().equals("s") && !getSegtype().equals("v")) {
            throw new IllegalArgumentException("Invalid SEGTYPE value - must be either: 'd', 'o', 's', 'v'");
        }
