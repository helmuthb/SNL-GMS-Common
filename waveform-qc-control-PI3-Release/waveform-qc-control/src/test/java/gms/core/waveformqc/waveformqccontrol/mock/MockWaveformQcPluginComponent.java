 ...
 */
public class MockWaveformQcPluginComponent implements WaveformQcPlugin {
   ...
   * registry
   */
  private MockWaveformQcPluginComponent() {
    this.name = "mock";
   ...
   */
  public static MockWaveformQcPluginComponent from() {
    return new MockWaveformQcPluginComponent();
  }
