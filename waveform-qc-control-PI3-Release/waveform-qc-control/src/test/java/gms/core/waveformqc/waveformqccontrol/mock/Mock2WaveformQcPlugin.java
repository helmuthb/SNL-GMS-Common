 ...
 */
public class Mock2WaveformQcPlugin implements WaveformQcPlugin {
   ...
   * registry
   */
  public Mock2WaveformQcPlugin() {
    this.name = "mock2";
    this.pluginVersion = PluginVersion.from(2, 1, 1);
  }
  ...
  public static QcMask mockQcMask() {
    final Instant begin = Instant.parse("2016-09-25T10:00:00.00Z");
    final Instant end = begin.plusSeconds(60);

    return QcMask
        .from(new UUID(0L, 0L), new UUID(0L, 0L),
            Collections.singletonList(QcMaskVersion.from(
